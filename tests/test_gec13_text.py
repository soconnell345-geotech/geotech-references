...
class TestLoadChapter:
    ...
    @pytest.mark.parametrize("chapter", list(range(1, 6)))
    def test_all_chapters_load(self, chapter):
        """All GEC-13 chapter JSON files load without error."""
        try:
    ...
    def test_chapter2_has_drain_content(self):
        ...
        try:
            ...
            pytest.skip("Chapter 2 not yet created")
        assert any(
